...
pretrained_ckpt_dict = {
    "SparseStructureEncoder": "JeffreyXiang/TRELLIS-image-large/ckpts/ss_enc_conv3d_16l8_fp16",
    "SparseStructureDecoder": "JeffreyXiang/TRELLIS-image-large/ckpts/ss_dec_conv3d_16l8_fp16",
    "SLatMeshDecoder": "JeffreyXiang/TRELLIS-image-large/ckpts/slat_dec_mesh_swin8_B_64l8m256c_fp16",
    "SLatRadianceFieldDecoder": "JeffreyXiang/TRELLIS-image-large/ckpts/slat_dec_rf_swin8_B_64l8r16_fp16",
    "SLatEncoder": "JeffreyXiang/TRELLIS-image-large/ckpts/slat_enc_swin8_B_64l8_fp16",
    "SLatGaussianDecoder": "JeffreyXiang/TRELLIS-image-large/ckpts/slat_dec_gs_swin8_B_64l8gs32_fp16",
}
...
def main(local_rank, cfg):
    ...
    if cfg.pretrained:
        model_dict = {
            name: models.from_pretrained(pretrained_ckpt_dict[model["name"]]).cuda()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained', action='store_true', help='Finetune from pretrained models.')
